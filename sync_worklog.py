...
SYNC_MUTATION = """
mutation SyncJiraWorklogsFromJiraProject($projectId: Int!, $from: DateTime!) {
  syncJiraWorklogsFromJiraProject(projectId: $projectId, from: $from) {
    message
  }
}
"""
    ...
    for project in target_projects:
        ...
        try:
            ...
            if "errors" in sync_data:
                ...
                sync_message = sync_data["data"]["syncJiraWorklogsFromJiraProject"]["message"]
                print(f"  ✅ Sync Successful: {sync_message}")
